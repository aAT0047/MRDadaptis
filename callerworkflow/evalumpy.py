...
# 从CSV文件读取前305个样本的数据
# 合并CSV文件
def merge_all_csv_files(csv_path, output_file):
    ...
    print(f"所有CSV文件已合并并保存到 {output_file}")
...
def mulit_2lumpymain():
    ...
    print("All samples processed.")
      # 合并所有CSV文件
    output_csv_file = os.path.join(csv_path, 'mergedlumpysarcoma.csv')
    merge_all_csv_files(csv_path, output_csv_file)
