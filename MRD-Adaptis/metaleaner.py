...
# 加载元数据
df = pd.read_csv(r"C:\Users\1\Desktop\SVstabilizer\NEWFIG\revi\MRD-Adaptis-main\MRD-Adaptis\metadata_demo.csv")
df = df.iloc[:, 1:-3]
df = df.dropna()
...
torch.save(model.state_dict(), r'C:\Users\1\Desktop\SVstabilizer\NEWFIG\revi\MRD-Adaptis-main\MRD-Adaptis\multi_target_regression_model1.pth')
